...
def generate_drink_report() -> str:
    ...
    prompt = (
        ...
        "Особый акцент: кофе/энергетики/газировка — это не вода, так что если воды мало, а остального "
        "много, подчеркни этот контраст с юмором. Никаких врачебных советов, только лёгкая подначка.\n\n"
