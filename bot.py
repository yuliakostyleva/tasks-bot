...
def generate_drink_report() -> str:
    ...
    prompt = (
        ...
        "безличное, как будто голос стороннего наблюдателя. Не используй гендерные обращения к читателям "
        "вроде «девочки», «подружки» и т.п. — среди тех, кто это читает, есть и мужчина. "
        "Особый акцент: кофе/энергетики/газировка — "
